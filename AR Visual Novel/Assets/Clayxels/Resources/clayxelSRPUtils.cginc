...
#ifdef SHADERPASS // make sure we detect the shadow pass in HDRP and URP the same way
...
void clayxelVert(uint vId, out float4 tex, out float3 vertexColor, out float3 outVertPos, out float3 outNormal){
